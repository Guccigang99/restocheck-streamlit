...
st.set_page_config(page_title="Roostercontrole", page_icon="📅", layout="wide")
init_db()
...
st.info(
    "Hier komt de bestaande wettelijke controlelogica. "
    "De gemarkeerde Excel-export blijft hetzelfde als in de vorige tool."
)
